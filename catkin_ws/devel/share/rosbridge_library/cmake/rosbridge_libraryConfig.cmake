...
if("TRUE" STREQUAL "TRUE")
  set(rosbridge_library_SOURCE_PREFIX /home/pi/catkin_ws/src/rosbridge_suit/rosbridge_library)
  set(rosbridge_library_DEVEL_PREFIX /home/pi/catkin_ws/devel)
  ...
  set(rosbridge_library_INSTALL_PREFIX /home/pi/catkin_ws/install)
...
if(NOT "/home/pi/catkin_ws/devel/include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rosbridge_library' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/rosbridge_suit/rosbridge_library/${idir}'.  Ask the maintainer 'Russell Toris <rctoris@wpi.edu>, Jihoon Lee <jihoonlee.in@gmail.com>' to fix it.")
    endif()
