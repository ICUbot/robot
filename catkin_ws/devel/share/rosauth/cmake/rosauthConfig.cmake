...
if("TRUE" STREQUAL "TRUE")
  set(rosauth_SOURCE_PREFIX /home/pi/catkin_ws/src/rosauth)
  set(rosauth_DEVEL_PREFIX /home/pi/catkin_ws/devel)
  set(rosauth_INSTALL_PREFIX "")
  set(rosauth_PREFIX ${rosauth_DEVEL_PREFIX})
else()
  set(rosauth_SOURCE_PREFIX "")
  set(rosauth_DEVEL_PREFIX "")
  set(rosauth_INSTALL_PREFIX /home/pi/catkin_ws/install)
...
if(NOT "/home/pi/catkin_ws/devel/include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rosauth' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/rosauth/${idir}'.  Ask the maintainer 'Russell Toris <rctoris@wpi.edu>' to fix it.")
    endif()
